#!/usr/bin/env python3
"""Operator transaction for the one-shot service-applied-revision main publisher.
...
STAGED_BRANCH = "chore/service-applied-revision-publish-dispatcher-staged-20260924"
DISPATCH_BRANCH = "automation/dispatch-service-applied-revision-main-publish"
