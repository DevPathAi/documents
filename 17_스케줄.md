...
- [x] 학습경로·콘텐츠·Sandbox·AI 리뷰·멘토·커뮤니티 도메인 API **구현 완료**(2026-07-02 기준, 백엔드 총 52 엔드포인트) — 상세 [42_전체_정합성_점검_2차](./42_전체_정합성_점검_2차.md) §4.1
...
| 영역 | 현재 상태 | 다음 정합성 과제 |
|---|---|---|
| 인증/사용자 | 부분 구현 (platform-svc 4 엔드포인트) | OAuth provider별 E2E, gateway edge 흐름 확인 |
...
| 커뮤니티 | 구현(community-svc 10종: Q&A·투표·배지·평판) | moderation·검색·북마크 등 후속(TARGET) |
