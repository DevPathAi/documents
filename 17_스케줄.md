...
- [x] 학습경로·콘텐츠·Sandbox·AI 리뷰·멘토·커뮤니티 도메인 API **구현 완료**(백엔드 총 **70 엔드포인트**, 2026-07-18 정합성 3차 실측) — 상세 [46_전체_정합성_점검_3차](./46_전체_정합성_점검_3차.md) §5. (증가분 +18: 베타 게이팅·설정/동의·마이페이지 avatar/profile·재참여·게스트 진단)
...
| 영역 | 현재 상태 | 다음 정합성 과제 |
|---|---|---|
| 인증/사용자 | 구현 (platform-svc 16 엔드포인트: auth·admin·beta·consent·avatar/profile) | OAuth provider별 E2E, gateway edge 흐름 확인 |
